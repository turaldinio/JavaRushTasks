...
File file=new File("/Users/niklaus/Documents/JavaRushTasks/2.JavaCore/src/com/javarush/task/task20/task2013/output");
        ...
        try {
            ...
            System.out.println(newPerson.firstName+" "+newPerson.lastName+" "+newPerson.age+" "+newPerson.father+" "+newPerson.mother);
    ...
    public static class Person implements Externalizable {
        ...
        public void writeExternal(ObjectOutput out) throws IOException {
            ...
            out.writeObject(mother); //this добавлял для себя
